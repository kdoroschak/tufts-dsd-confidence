...
parser.add_argument("-s", "--sequencefile", help="sequence distance matrix")
...
parser.add_argument("-m", "--mode", default=0,
                    ...
                    + " DSD; 2 for weighted DSD, 3 for sequence-based."
                    + " Type 0 by default", type=int, choices=[0, 1, 2, 3])
parser.add_argument("-a", help="DSD scale value, 1 by default", 
                    default=1, type=float)
parser.add_argument("-b", help="Sequence scale value, 1 by default", 
                    default=1, type=float)
parser.add_argument("-N", help="sequence normalizer, 1 by default", 
                    default=1, type=float)
...
if options.mode == 1:
    ...
    prediction = mvote.SeqDSDWeightedMV(ppfDSD, ppfSeq, ppbLabel, pnFoldIndex, pnRD, options.neighbor, options.a, options.b, options.N)
